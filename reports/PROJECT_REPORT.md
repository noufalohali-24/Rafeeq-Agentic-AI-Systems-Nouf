...
- Assessment run ID | معرّف تشغيل التقييم: `run-51fee02a6b394bdc`
- Generated UTC | وقت الإنشاء: 2026-09-22T08:37:44.736622+00:00
...
- Median latency | وسيط الزمن: 1.975 ms
...
- Before | قبل: 3.81 ms / 500 iterations
- After | بعد: 0.467 ms / 500 iterations
- Cache hits / misses | إصابات / إخفاقات التخزين: 499 / 1
- Learner trade-off and guardrail | مقايضة وضابط المتدرب: Measured trade-off: for 500 policy lookups, caching reduced runtime from 3.81 ms to 0.467 ms, but cached policy data can become stale. Guardrail: key the cache by locale, category, and active policy version, and never include customer data in the cache key.
